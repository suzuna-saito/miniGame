...
{
    // エリアの描画
    DrawBox((int)mPos.x, (int)mPos.y, (int)mSize.x, (int)mSize.y, GetColor(40, 40, 40), TRUE);      // 灰色の塗りつぶしエリア
    DrawBox((int)mPos.x, (int)mPos.y, (int)mSize.x, (int)mSize.y, GetColor(255, 255, 255), FALSE);  // エリアをかこっている白い線
